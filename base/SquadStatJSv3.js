...
// Creates SquadStatJSv3 class
class SquadStatJSv3 extends Client {
	constructor() {
		super({
			intents: [
		...
		this.player
			...
			.on("playlistStart", (message, queue, playlist, track) => {
				message.channel.send(
					this.customEmojis.success +
						" | " +
						message.translate("music/play:PLAYING_PLAYLIST", {
