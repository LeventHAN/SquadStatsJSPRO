...
class Giveaway extends Command {
	...
	async run(message, args, data) {
		...
		if (status === "create") {
			const currentGiveaways = this.client.giveawaysManager.giveaways.filter(
			...
			this.client.giveawaysManager
				.start(message.channel, {
					...
					messages: {
						...
						timeRemaining: message.translate(
							"moderation/giveaway:TIME_REMAINING"
						),
						inviteToParticipate: message.translate(
							"moderation/giveaway:INVITE_PARTICIPATE"
						),
